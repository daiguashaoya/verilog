...
HD_PWD='D:/verilog/verilog/project3_6/project3_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_scan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dynamic_scan.tcl -notrace
