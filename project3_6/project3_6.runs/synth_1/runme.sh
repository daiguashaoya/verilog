...
HD_PWD='D:/verilog/verilog/project3_6/project3_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_scan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dynamic_scan.tcl
