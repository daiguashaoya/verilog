...
HD_PWD='D:/verilog3.28/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Direct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7Seg_Driver_Direct.tcl
