...
HD_PWD='D:/verilog/verilog/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Choice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7Seg_Driver_Choice.tcl
