...
HD_PWD='D:/verilog3.28/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7Seg_Driver_Decode.tcl
