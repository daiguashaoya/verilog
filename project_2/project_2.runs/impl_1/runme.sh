...
HD_PWD='D:/verilog3.28/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Decode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _7Seg_Driver_Decode.tcl -notrace
