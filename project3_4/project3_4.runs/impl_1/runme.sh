...
HD_PWD='D:/verilog/verilog/project3_4/project3_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom8x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom8x4.tcl -notrace
