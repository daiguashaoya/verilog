...
HD_PWD='D:/verilog/verilog/project3_4/project3_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom8x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom8x4.tcl
